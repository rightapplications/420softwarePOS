...
$count = $oOrder->deliverySalesCount($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to']);

$gross = $oOrder->grossDeliverySales($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to']);

$net = $oOrder->netDeliverySales($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to']);

include '../templates/POS/reports_delivery_tpl.php';
?>