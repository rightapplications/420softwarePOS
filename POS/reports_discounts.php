...
//sorting
if(isset($_GET['ordby'])){
    $_SESSION[CLIENT_ID]['sorting']['discounts']['ordby'] = $_GET['ordby'];
}
if(isset($_SESSION[CLIENT_ID]['sorting']['discounts']['ordby'])){
    $ordby = $_SESSION[CLIENT_ID]['sorting']['discounts']['ordby'];
}else{
    $ordby = '';
}
if(isset($_GET['ord'])){
    $_SESSION[CLIENT_ID]['sorting']['discounts']['ord'] = $_GET['ord'];
}
if(isset($_SESSION[CLIENT_ID]['sorting']['discounts']['ord'])){
    $ord = $_SESSION[CLIENT_ID]['sorting']['discounts']['ord'];
}else{
    $ord = '';
}
$aDiscounts = $oOrder->get_discounts($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to'], $ordby, $ord); //dump($aDiscounts);

include '../templates/POS/reports_discounts_tpl.php';