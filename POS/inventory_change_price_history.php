...
$aItems = $oInventory->getPriceUpdatingLog($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to'],  $ordby, $ord);

include '../templates/POS/inventory_change_price_history_tpl.php';