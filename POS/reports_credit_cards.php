...
$count = $oOrder->ccSalesCount($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to']);

$gross = $oOrder->grossCCSales($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to']);

$net = $oOrder->netCCSales($_SESSION[CLIENT_ID]['from'], $_SESSION[CLIENT_ID]['to']);

include '../templates/POS/reports_credit_cards_tpl.php';
?>